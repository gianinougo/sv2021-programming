//Author: Franco (...)
/*
151. Crea una nueva versión de la biblioteca (ejercicio 91), 
partiendo de la solución oficial, con los siguientes cambios: 
No debe haber un "struct TipoLibro" sino un "class Libro", 
con propiedades en formato corto (recuerda que desde Visual 
Studio puedes usar Ctrl+RR para renombrar un elemento en todos 
los puntos del programa en los que aparece). Debe tener un 
constructor que reciba los tres campos, un ToString que 
simplifique operaciones como la de "mostrar datos" y un 
"Contiene(texto)" que simplifique las búsquedas.
*/
