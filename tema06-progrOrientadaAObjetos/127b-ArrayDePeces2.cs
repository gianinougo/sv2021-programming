// 127b: Array de peces (versión con 2 "Nadar" distintos)
...
class PezEspada : Pez
{
    private int pasosHastaCambiarAltura;
    private int cambioDeAltura;
    ...
    public override void Nadar()
    {
        ...
        // Y hacemos que cambie su altura, para que sea parcialmente
        // distinto de un pez más genérico
        pasosHastaCambiarAltura --;
        if (pasosHastaCambiarAltura == 0)
        {
            y = (byte) (y+cambioDeAltura);
            cambioDeAltura = -cambioDeAltura;
            pasosHastaCambiarAltura = 5;
        }
    }
}
