// Ejercicio 138
// Propuesta inicial por: Virginia
// Versión completa 4, "Modificar" en la clase Documento
...
class Documento
{
    ...
    // Resto de métodos auxiliares: MostrarDatos, Modificar, Pedir
    ...
    public virtual void Modificar()
    {
        ...
        paginas = Convert.ToUInt16(Pedir("páginas"));
    }

    protected string Pedir(string campo)
    {
...
class Libro : Documento
{
    ...
    {
        base.Modificar();
        tapa = Convert.ToChar(Pedir("tapa"));
    }
}
