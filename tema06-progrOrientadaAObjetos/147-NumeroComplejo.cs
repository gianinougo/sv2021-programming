// JOSE (...), retoques por Nacho

/* 147. Un número complejo tiene dos partes: la parte real y la parte 
 * imaginaria. En un número de la forma a + bi (2-3i, por ejemplo), la parte 
 * real sería "a" (2) y la parte imaginaria sería "b" (-3).
 ...
 * Un método "Sumar", para sumar un número complejo (que se pasará como 
   ...
   partes reales, y la parte imaginaria será la suma de ambas partes 
   imaginarias)
