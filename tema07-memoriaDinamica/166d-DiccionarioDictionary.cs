...
// Versión d: Dictionary<string, string>
...
namespace ej166
{
    class Program
    {
        ...
        {
            string opcion;
            Dictionary<string, string> miDiccio = new Dictionary<string, string>();
            bool salir = false;
            ...
            do
            {
                ...
                switch (opcion)
                {
                    ...
                    case "3":
                        foreach (KeyValuePair<string, string> palabra in miDiccio)
